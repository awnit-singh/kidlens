...
export const AGE_GROUPS = [
  {
    ...
    tint: "var(--green-100)",
    blurb:
      "Developing brains process screens slowly. At this age the research favors slow pacing, live faces, direct speech, and lots of pauses.",
  },
  {
    id: "preschool",
    label: "Preschoolers",
    ...
    tint: "var(--coral-100)",
    blurb:
      "Story comprehension arrives, and so do big feelings. Social-emotional modeling, clear cause-and-effect, and gentle pacing matter most.",
  },
  {
    id: "early-elementary",
    ...
    tint: "var(--blue-100)",
    blurb:
      "Kids can follow faster stories and richer vocabulary now. Curriculum value and how conflict is resolved start to matter more than raw pace.",
  },
  {
    id: "big-kids",
    label: "Big Kids",
    ...
    tint: "var(--yellow-100)",
    blurb:
      "Complex plots, moral ambiguity, and real stakes are developmentally useful here — what matters is consequences shown and who gets to be the hero.",
  },
];
